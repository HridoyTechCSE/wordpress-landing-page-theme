...
$button_label_text = get_post_meta(get_the_ID(), "button label", true);
...
<aside id="fh5co-aside" role="sidebar" class="text-center home-side">
    <h1 id="fh5co-logo" class="countar-left">
...
<div id="fh5co-main-content">
    <div class="dt js-dt">
        <div class="dtc js-dtc">
            <div class="simply-countdown-one animate-box countar" data-animate-effect="fadeInUp"></div>
                        ...
                        <div class="col-lg-7 animate-box">
                            <form action="#" id="fh5co-subscribe">
                                <div class="form-group">
                                    ...
                                    <input type="submit" value="<?php echo esc_attr( $button_label_text ); ?>" class="btn btn-primary">
